...
public class CategoryHelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_help_activity);

        RecyclerView recyclerView = findViewById(R.id.recycler_help);
        ...
        map_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CategoryHelpActivity.this , MapActivity.class);
        ...
        chat_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryHelpActivity.this , ChatActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        profile_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryHelpActivity.this , ProfileActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        write_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryHelpActivity.this , WriteActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        category_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryHelpActivity.this , CategoryActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(text.equals("나눔")) {
                    Intent intent = new Intent(CategoryHelpActivity.this , CategorySplitActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                }
                else if(text.equals("봉사")) {
                    Intent intent = new Intent(CategoryHelpActivity.this , CategoryServiceActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                }
            }

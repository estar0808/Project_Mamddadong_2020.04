...
public class CategoryServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_service_activity);
        ...
        DatabaseReference databaseReference = database.getReference("Post").child("봉사");
        ...
        map_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CategoryServiceActivity.this , MapActivity.class);
        ...
        chat_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryServiceActivity.this , ChatActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        profile_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryServiceActivity.this , ProfileActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        write_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryServiceActivity.this , WriteActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        category_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CategoryServiceActivity.this , CategoryActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(text.equals("나눔")) {
                    Intent intent = new Intent(CategoryServiceActivity.this , CategorySplitActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                } else if(text.equals("부탁")) {
                    Intent intent = new Intent(CategoryServiceActivity.this , CategoryHelpActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                }
            }
